...
function AboutLabourLink() {
  return (
    ...
    >
      <Paper
        elevation={3}
        sx={{ padding: "20px", maxWidth: "800px", width: "100%" }}
      >
        <Typography variant="h5" sx={titleStyles.h5}>
          About Labour Link
        </Typography>
        <Typography variant="body1" paragraph sx={{ fontFamily: "Montserrat" }}>
          Welcome to Labour Link, a comprehensive platform designed to
          streamline the process of finding, hiring, and managing laborers for
          various tasks and projects. Whether you're a customer in need of
          skilled workers or a worker looking for job opportunities, Labour Link
          provides a seamless and efficient solution to connect users with the
          right resources.
        </Typography>
        <Typography variant="body1" paragraph sx={{ fontFamily: "Montserrat" }}>
        ...
        <Typography variant="body1" paragraph sx={{ fontFamily: "Montserrat" }}>
          ...
          <br />
          - Map View: Customers can view nearby workers on a map using Google
          API, facilitating easier selection and hiring.
          <br />
          ...
          <br />
          - Hiring Requests: Access a list of hiring requests received,
          including details such as customer name, job title, and location.
          <br />
          ...
          <br />
          - Notification Alerts: Receive notifications for new user
          registrations and other important system events.
          <br />
          ...
          <br />- Access Control: Admins have control over various aspects of
          the system to maintain security and integrity.
        </Typography>
        ...
        <Typography variant="body1" paragraph sx={{ fontFamily: "Montserrat" }}>
          ...
          extensive features and dedicated support, we strive to make the
          process of finding, hiring, and managing laborers as seamless and
